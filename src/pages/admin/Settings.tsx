      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card className="p-6 shadow-soft">
          ...
          <div className="mt-5 space-y-2 text-sm text-muted-foreground">
            <p className="flex items-center gap-2"><MapPin className="h-4 w-4 text-primary" /> 12 Birch Grove, Cardiff, CF14 3ET</p>
            <p className="flex items-center gap-2"><HeartPulse className="h-4 w-4 text-primary" /> info@manasseh.care · 029 2074 0000</p>
